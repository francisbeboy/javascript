...
mysql.createConnection({
    ...
    app.post('/connexion', async (req,res)=>{
        req.check('email','l\'Vous devez renseiller un email correct!').notEmpty()
        req.check('password','renseillez votre mode de passe si vous plais!').notEmpty()
        const error = req.validationErrors()
        if(error){
...
.catch((error)=>{
    console.log("votre connexion a échoué")
})